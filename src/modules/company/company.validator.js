...
export const validateUpdateCompanyProfile = [
    ...
    body('taxId')
        .optional()
        .trim()
        .matches(/^[a-zA-Z0-9\-]+$/).withMessage('El ID tributario contiene caracteres inválidos'), // Ajusta regex según tu país (CUIT, RUT, NIT)
    ...
    body('logoUrl')
        .optional()
        .trim()
        .isURL().withMessage('La URL del logo no es válida'),
];
